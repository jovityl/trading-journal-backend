    ...
    public static class MappingHelper
    {
        public static TradeDto ToDto(this Trade entity)
        {
            return new TradeDto
            {
                ...
                HasStopLoss = entity.HasStopLoss,
                HasProfitTarget = entity.HasProfitTarget,
                HasPositionSizing = entity.HasPositionSizing,
                HasAppropriateDte = entity.HasAppropriateDte,
